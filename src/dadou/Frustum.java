...
public class Frustum {
	...
	public void calculateFrustum() {
		...
		// Below, we pass in GL_PROJECTION_MATRIX to abstract our projection
		// matrix.
		...
		// By passing in GL_MODELVIEW_MATRIX, we can abstract our model view
		// matrix.
		...
		// Now that we have our modelview and projection matrix, if we combine
		// these 2 matrices,
		// it will give us our clipping planes. To combine 2 matrices, we
		// multiply them.
	...
	public int cubeInFrustum(Vector3f center, float size) {
	...
	public int cubeInFrustum(float x, float y, float z, float size) {
