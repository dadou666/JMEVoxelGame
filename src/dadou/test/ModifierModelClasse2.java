...
public class ModifierModelClasse2 {
	...
	//	ModelClasse mc = decorDeBriqueData.models.get("objet.transfert_tete#model");
		String nom ="objet.portail";
		Habillage h = (Habillage) SerializeTool.load(cheminRessources + "/sprite.hab");
		int dx=6;
		int dy=6
